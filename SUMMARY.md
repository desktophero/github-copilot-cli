...
> **⚠️ MAJOR UPDATE**: This repository has been completely updated to reflect the deprecation of the `gh copilot` CLI extension and the introduction of the new standalone GitHub Copilot CLI.
